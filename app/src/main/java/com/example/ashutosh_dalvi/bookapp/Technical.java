...
public class Technical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference ref= FirebaseDatabase.getInstance().getReference("Books/Technical");
        ...
        Recyclerview_adapter adapter =new Recyclerview_adapter(rv,Technical.this,technical);
    ...
    public boolean search_click(MenuItem item){
        Intent i = new Intent(Technical.this, Search.class);
